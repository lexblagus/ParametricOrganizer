...
const visibleHeight = 12.5; // naked area
const moduleQtt = [1, 4]; // cols, rows
...
const clearanceFloor = 1.5;
const clearanceBox = 0.5;
const clearanceCover = 0.5;
...
const hocHeight = 0 - msdcDimensions[1] + visibleHeight;
